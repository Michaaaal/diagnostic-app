...
public class CoreExceptionHandler {
    ...
    public String handleExpiredJwtException(ExpiredJwtException e, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("message", new AuthResponse("Token is expired", ResponseType.ERROR));
    ...
    public String handleUnsupportedJwtException(UnsupportedJwtException e, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("message", new AuthResponse("Unsupported JWT token", ResponseType.ERROR));
        return "redirect:/login";
    }
    ...
    public String handleMalformedJwtException(MalformedJwtException e, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("message", new AuthResponse("Malformed JWT token", ResponseType.ERROR));
        return "redirect:/login";
    }
    ...
    public String handleSignatureException(SignatureException e, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("message", new AuthResponse("Invalid JWT signature", ResponseType.ERROR));
        return "redirect:/login";
    }
    ...
    public String handleDecodingException(DecodingException e, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("message", new AuthResponse("Unable to decode JWT token", ResponseType.ERROR));
        return "redirect:/login";
    }
    ...
    public String handleRuntimeException(RuntimeException e, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("message", new AuthResponse("Runtime Exception", ResponseType.ERROR));
